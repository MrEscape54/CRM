...
ACC_INDUSTRY = (
    ...
    ("Apparel & Accesories", _("Apparel & Accesories")),
    ("Automotive", _("Automotive")),
    ("Banking", _("Banking")),
    ("Biotechnology", _("Biotechnology")),
    ("Building & Equipment", _("Building & Equipment")),
    ("Chemical", _("Chemical")),
    ("Education", _("Education")),
    ("Electronics", _("Electronics")),
    ("Utilities", _("Utilities")),
    ("Oil & Gas", _("Oil & Gas")),
    ("Entertainment & Leisure", _("Entertainment & Leisure")),
    ("Finance", _("Finance")),
    ...
    ("Real State", _("Real State")),
    ("Security Services", _("Security Services")),
    ("Profesional Services", _("Profesional Services")),
    ("Sports", _("Sports")),
