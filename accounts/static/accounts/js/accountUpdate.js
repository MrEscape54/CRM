$(document).ready(function () {
  document.querySelector("#modal_create").onclick = function () {
    ...
    const parentId = document.getElementById("parent").getAttribute("data-parent");
    const accountId = document.getElementById("account").getAttribute("data-account");
        ...
        fetch(`/api/parents/${parentId}/`, {
          ...
          if (response.ok) {
            return response.json().then(result => {
              ...
              drop.add(option); */
              const modal = document.querySelector(".ui.mini.modal");
